import BulldozerIcon from '%/icons/bulldozer-icon.svg'
import FacadeIcon from '%/icons/facade-icon.svg'
import FormworkIcon from '%/icons/formwork-icon.svg'
import HighlightedText from '@/components/HighlightedText'
import IconBg1 from '@/svgs/IconBg1'
import IconBg2 from '@/svgs/IconBg2'
import ItemBlock from '@/components/ItemBlock'
import PaintrollerIcon from '%/icons/paintroller-icon.svg'
import PanelsIcon from '%/icons/panels-icon.svg'
import PipeIcon from '%/icons/pipe-icon.svg'
import ScaffoldIcon from '%/icons/scaffold-icon.svg'
import TrashbinIcon from '%/icons/trashbin-icon.svg'
